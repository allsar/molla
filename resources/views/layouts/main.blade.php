...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('js/DataTables/DataTables-1.13.5/css/dataTables.bootstrap.min.css') }}">
    @yield('Page-css')
    <!-- END: Page CSS-->
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="layout"></i><span class="menu-title text-truncate" data-i18n="Page Layouts">Page Layouts</span></a>
                <ul class="menu-content">
                    ...
                    <li class="active"><a class="d-flex align-items-center" href="layout-full.html"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Layout Full">Layout Full</span></a>
                    </li>
...
<script src="{{asset('app-assets/vendors/js/jquery/jquery.min.js')}}"></script>
<script src="{{asset('js/DataTables/DataTables-1.13.5/js/dataTables.bootstrap.min.js')}}"></script>
<!-- END: Page Vendor JS-->
