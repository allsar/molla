...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('app-assets/images/ico/favicon.ic')}}o">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a class="d-flex align-items-center" href="index.html"><i
                        ...
                        class="badge badge-light-warning rounded-pill ms-auto me-1">5</span></a>
                <ul class="menu-content">
                    ...
                    <li><a class="d-flex align-items-center" href="{{route('properties.index')}}"><i
                                data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">Properties</span></a>
                    </li>
                </ul>
            </li>
